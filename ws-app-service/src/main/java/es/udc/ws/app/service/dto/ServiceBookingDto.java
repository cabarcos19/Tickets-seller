...
public class ServiceBookingDto {
    ...
    public ServiceBookingDto(long id_booking,String email, String credit_card, LocalDateTime date_time_book, long id_show, float discounted_price,
    ...
    public String toString() {
        return "ServiceBookingDto [id_booking=" + id_booking + ", email=" + email + ", credit_card=" + credit_card
                + ", date_time_book=" + date_time_book + ", id_show=" + id_show + ", discounted_price="
                + discounted_price + ", used=" + used + ", num_tickets=" + num_tickets + "]";
    }    

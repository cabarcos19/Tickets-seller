...
public class ClientBookingDto {
	...
	public ClientBookingDto(long id_booking, String email, String credit_card, LocalDateTime date_time_book,
			long id_show, float discounted_price, boolean used, int num_tickets) {
		super();
